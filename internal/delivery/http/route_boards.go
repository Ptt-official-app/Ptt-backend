...
func marshalBoardSettings(b bbs.BoardRecord) map[string]interface{} {
	ret := map[string]interface{}{
		"hide":                               strconv.FormatBool(b.(bbs.BoardRecordSettings).IsHide()),
		"restricted_post_or_read_permission": strconv.FormatBool(b.(bbs.BoardRecordSettings).IsPostMask()),
		"anonymous":                          strconv.FormatBool(b.(bbs.BoardRecordSettings).IsAnonymous()),
		"default_anonymous":                  strconv.FormatBool(b.(bbs.BoardRecordSettings).IsDefaultAnonymous()),
		"no_money":                           strconv.FormatBool(b.(bbs.BoardRecordSettings).IsNoCredit()),
		"vote_board":                         strconv.FormatBool(b.(bbs.BoardRecordSettings).IsVoteBoard()),
		"warnel":                             strconv.FormatBool(b.(bbs.BoardRecordSettings).IsWarnEL()),
		"top":                                strconv.FormatBool(b.(bbs.BoardRecordSettings).IsTop()),
		"no_comment":                         strconv.FormatBool(b.(bbs.BoardRecordSettings).IsNoRecommend()),
		"angel_anonymous":                    strconv.FormatBool(b.(bbs.BoardRecordSettings).IsAngelAnonymous()),
		"bm_count":                           strconv.FormatBool(b.(bbs.BoardRecordSettings).IsBMCount()),
		"no_boo":                             strconv.FormatBool(b.(bbs.BoardRecordSettings).IsNoBoo()),
		"allow_list_post_only":               strconv.FormatBool(b.(bbs.BoardRecordSettings).IsRestrictedPost()),
		"guest_post_only":                    strconv.FormatBool(b.(bbs.BoardRecordSettings).IsGuestPost()),
		"cooldown":                           strconv.FormatBool(b.(bbs.BoardRecordSettings).IsCooldown()),
		"cross_post_log":                     strconv.FormatBool(b.(bbs.BoardRecordSettings).IsCPLog()),
		"no_fast_comment":                    strconv.FormatBool(b.(bbs.BoardRecordSettings).IsNoFastRecommend()),
		"log_ip_when_comment":                strconv.FormatBool(b.(bbs.BoardRecordSettings).IsIPLogRecommend()),
		"over18":                             strconv.FormatBool(b.(bbs.BoardRecordSettings).IsOver18()),
		"no_reply":                           strconv.FormatBool(b.(bbs.BoardRecordSettings).IsNoReply()),
		"aligned_comment":                    strconv.FormatBool(b.(bbs.BoardRecordSettings).IsAlignedComment()),
		"no_self_delete_post":                strconv.FormatBool(b.(bbs.BoardRecordSettings).IsNoSelfDeletePost()),
		"bm_mask_content":                    strconv.FormatBool(b.(bbs.BoardRecordSettings).IsBMMaskContent()),
	}
	return ret
}
