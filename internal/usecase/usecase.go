...
type Usecase interface {
	...
	ForwardArticleToBoard(ctx context.Context, userID, boardID, filename, toEmail string) (map[string]interface{}, error)
	ForwardArticleToEmail(ctx context.Context, userID, boardID, filename, toBoard string) (map[string]interface{}, error)
}
